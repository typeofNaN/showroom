...
`,[s("input, textarea",`
 ...
 `),S("&:-webkit-autofill ~",[s("placeholder","display: none;")])]),z("round",[K("textarea","border-radius: calc(var(--n-height) / 2);")]),s("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 `)]),z("textarea",[s("placeholder","overflow: visible;")]),K("autosize","width: 100%;"),z("autosize",[s("textarea-el, input-el",`
 position: absolute;
 top: 0;
 left: 0;
 height: 100%;
 ...
 display: flex;
 align-items: center; 
 `)])]),K("textarea",[s("placeholder","white-space: nowrap;")]),s("eye",`
 display: flex;
 align-items: center;
