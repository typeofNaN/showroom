...
`,[S(">",[u("clear",`
 ...
 `,[gn({originalTransform:"translateX(-50%) translateY(-50%)",left:"50%",top:"50%"})])])]),me=R({name:"BaseClear",props:{clsPrefix:{type:String,required:!0},show:Boolean,onClear:Function},setup(t){return Ee("-base-clear",Nr,pe(t,"clsPrefix")),{handleMouseDown(a){a.preventDefault()}}},render(){const{clsPrefix:t}=this;return o("div",{class:`${t}-base-clear`},o(bn,null,{default:()=>{var a,r;return this.show?o("div",{key:"dismiss",class:`${t}-base-clear__clear`,onClick:this.onClear,onMousedown:this.handleMouseDown,"data-clear":!0},q(this.$slots.icon,()=>[o(ae,{clsPrefix:t},{default:()=>o(Vr,null)})])):o("div",{key:"icon",class:`${t}-base-clear__placeholder`},(r=(a=this.$slots).placeholder)===null||r===void 0?void 0:r.call(a))}}))}}),Or=R({name:"InternalSelectionSuffix",props:{clsPrefix:{type:String,required:!0},showArrow:{type:Boolean,default:void 0},showClear:{type:Boolean,default:void 0},loading:{type:Boolean,default:!1},onClear:Function},setup(t,{slots:a}){return()=>{const{clsPrefix:r}=t;return o(yn,{clsPrefix:r,class:`${r}-base-suffix`,strokeWidth:24,scale:.85,show:t.loading},{default:()=>t.showArrow?o(me,{clsPrefix:r,show:t.showClear,onClear:t.onClear},{placeholder:()=>o(ae,{clsPrefix:r,class:`${r}-base-suffix__arrow`},{default:()=>q(a.default,()=>[o(Lr,null)])})}):null})}}}),De=wn("n-input");function Ur(t){let a=0;for(const r of t)a++;return a}function ne(t){return t===""||t==null}function Hr(t){const a=C(null);function r(){const{value:s}=t;if(!(s!=null&&s.focus)){p();return}const{selectionStart:f,selectionEnd:d,value:v}=s;if(f==null||d==null){p();return}a.value={start:f,end:d,beforeText:v.slice(0,f),afterText:v.slice(d)}}function l(){var s;const{value:f}=a,{value:d}=t;if(!f||!d)return;const{value:v}=d,{start:h,beforeText:c,afterText:b}=f;let x=v.length;if(v.endsWith(b))x=v.length-b.length;else if(v.startsWith(c))x=c.length;else{const D=c[h-1],T=v.indexOf(D,h-1);T!==-1&&(x=T+1)}(s=d.setSelectionRange)===null||s===void 0||s.call(d,x,x)}function p(){a.value=null}return re(t,p),{recordCursor:r,restoreCursor:l}}const Te=R({name:"InputWordCount",setup(t,{slots:a}){const{mergedValueRef:r,maxlengthRef:l,mergedClsPrefixRef:p,countGraphemesRef:s}=ke(De),f=M(()=>{const{value:d}=r;return d===null||Array.isArray(d)?0:(s.value||Ur)(d)});return()=>{const{value:d}=l,{value:v}=r;return o("span",{class:`${p.value}-input-word-count`},xn(a.default,{value:v===null||Array.isArray(v)?"":v},()=>[d===void 0?f.value:`${f.value} / ${d}`]))}}}),jr=w("input",`
 max-width: 100%;
 cursor: text;
 line-height: 1.5;
 z-index: auto;
